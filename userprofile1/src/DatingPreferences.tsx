...
type DatingPreferencesProps = {
  userData: UserData
  setUserData: React.Dispatch<React.SetStateAction<UserData>>
}

export default function DatingPreferences({ userData, setUserData }: DatingPreferencesProps) {
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="dating-preferences">
        <AccordionTrigger>Dating Preferences</AccordionTrigger>
        <AccordionContent>
          {['datingIntentions', 'relationshipType'].map((field) => (
